  ...
  return (
    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        ...
        <p className="text-white mt-4">Please use Edge or Chrome browsers to view this website!</p>
        <motion.a
           href="/more"
           target="_blank"
         ...
         >
           Click here to learn more about my <span className="text-rose-50 font-semibold text-2xl text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">resume</span>! 
        </motion.a>
        <motion.a
 href="/score"
target="_blank"
 ...
 className="py-2 button-primary text-center text-white cursor-pointer rounded-lg max-w-[200px]"
 >
Click here to learn more about my <span className="text-rose-50 font-semibold text-2xl text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">GPA</span>! 
 </motion.a>
      </div>
      ...
      >
        <Image
          ...
          width={700}
        />
        <div className="text-rose-50 font-semibold text-2xl text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">
